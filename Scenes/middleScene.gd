...
var dialogues = [
	...
	["No evidence of how it vanished, either. The lock is still intact and all my guards are alive.", 0], 
	["WOAH… that’s crazy...", 1], 
	["I know….", 0], 
	...
	["And I know for a fact that my wealth is what they find me the most charming.", 0], 
	["Not saying that I’m lacking in other aspects, of course.", 0], 
	["But it’ll be rather devastating if they no longer want to proceed because of this.", 0], 
	...
	["You see, I’ve been in search of some… inspiration. For my new book.", 0],
...
var thanks = [
	...
	["You’re welcome!!", 1],
	["Oh, and no worries about the payment. It’s on the house… or on the car?", 1],
	...
	["I imagine it’ll be particularly dangerous for someone like you who lives alone, in a caravan.", 0],
	["Is that so? Thank you for the heads up, I’ll keep an eye out!", 0],
	["Take care, charm maker. Thanks for your help!", 1],
	[null, 2],
	
	# level 1 - ray
	["Here you go!", 1],
	["Oh? This is quite the item.", 0],
	["Thank you, it’s very pretty. I hope it’ll attract Eldritch beings with its charm.", 0],
	["I… I hope so too!", 1],
