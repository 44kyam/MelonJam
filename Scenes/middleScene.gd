...
var dialogues = [
	...
	["Looks like you're my second customer of the day!", 1],
	...
	["It's already dark outside, time to close up the shop.", 1], 
...
var thanks = [
	...
	["Are you sure?", 0],
	["Yes! I hope you can get your money back soon...", 1],
	["I hope so too...", 0],
	["It’s still strange though, how all the gold vanished without a trace...", 1],
	["I'm aware. Still can't quite wrap my head around it, frankly speaking.", 0],
	["Since I can't pay you with my gold, allow me to offer you some information instead.", 0],
	["There’s been the talk of Eldritch beings roaming around the area.", 0],
	["You might want to look out for yourself.", 0],
	["Eldritch beings!?!", 0],
	["Indeed. I imagine it’ll be particularly dangerous for someone like you who lives alone, in a caravan to count.", 0],
	["I see... Thank you for the heads up, I’ll keep an eye out!", 0],
